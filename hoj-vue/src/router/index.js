      ...
      switch (to.meta.access) {
        case "discussion":
          if (!webConfig.openPublicDiscussion) {
            ...
            mMessage.error(
              i18n.t(
                "m.No_Access_There_is_no_open_discussion_area_on_the_website",
              ),
            );
          }
          break;
        case "groupDiscussion":
          if (!webConfig.openGroupDiscussion) {
            ...
            mMessage.error(
              i18n.t(
                "m.No_Access_There_is_no_open_group_discussion_area_on_the_website",
              ),
            );
          }
          break;
        case "contestComment":
          if (!webConfig.openContestComment) {
            ...
            mMessage.error(
              i18n.t(
                "m.No_Access_There_is_no_open_contest_comment_area_on_the_website",
              ),
            );
          }
          break;
