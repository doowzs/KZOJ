export const m = {
  ...
  NavBar_Contest_All_Submission: "提交情况",
  NavBar_Contest_Own_Submission: "我的提交",
  NavBar_Contest_Rank: "比赛排名",
  ...
  List_Solved_Problems_Recent: "近60天已解决问题列表",
  UserHome_Not_Data: "这家伙太懒了，还没有做过题...",
  Personal_Profile: "个人简介",
  UserHome_Solved_Problems: "做题情况（全部）",
  UserHome_Solved_Problems_Recent: "做题情况（近60天）",
  ...
  Are_you_sure_you_want_to_reset_your_code:
    "你是否确定要重置原始代码？如果该题有代码模板，则还原为原始模板的代码，否则正在编辑的代码将清空。",
  ...
  Problem_Score: "题目总分",
  OI_Rank_Score: "排行得分",
  OI_Rank_Calculation_Rule: "排行得分计算公式",
  ...
  Download_tips_1:
    "提供该记录第一个非AC的输入输出数据下载; 部分题目不开放数据下载。",
  ...
  Compile_Tips1:
    "__int64不是ANSI标准定义，只能在VC使用，在 GNU C++ 中应写成 long long 类型， scanf和printf 请使用%lld作为格式",
  ...
  Problem_Uncertain_Answer:
    "注意：本题可能存在多个符合题目要求的输出，请自行判断程序输出是否通过。",
  Fill_Case: "填充用例",
  ...
  Announcement_of_contest_Q_and_A_area_tips2:
    "比赛过程中，仅自己与比赛管理员的评论可见！",
  Announcement_of_contest_Q_and_A_area_tips3:
    "比赛管理员评论不可回复，比赛结束评论恢复正常！",
  ...
  To_Enter_Training_Need_Password: "请输入该私有训练的密码（一般是123456）",
  ...
  Delete_Member: "踢出该成员",
  Delete_Member_Tips:
    "确定要踢出该成员吗？踢出后该成员将无法再查看团队资源！另外，如果该成员是团队负责人，那么团队也将被一同解散！",
