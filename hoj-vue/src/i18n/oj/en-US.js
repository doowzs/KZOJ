export const m = {
  // /src/common/api.js
  Query_error_unable_to_find_the_resource_to_request:
    "Query error! Unable to find the resource to request!",
  Server_error_please_refresh_again: "Server error! Please refresh again!",
  Request_timed_out_please_try_again_later:
    "Request timed out! Please try again later!",
  Network_error_abnormal_link_with_server_please_try_again_later:
    "Network error! Abnormal link with server, Please try again later!",
  Error: "Error",
  Success: "Success",
  No_Access_There_is_no_open_discussion_area_on_the_website:
    "No Access: There is no open discussion area on the website!",
  No_Access_There_is_no_open_group_discussion_area_on_the_website:
    "No Access: There is no open group discussion area on the website!",
  No_Access_There_is_no_open_contest_comment_area_on_the_website:
    "No Access: There is no open contest comment area on the website!",
  ...
  NavBar_Contest_All_Submission: "All Submissions",
  NavBar_Contest_Own_Submission: "My Submissions",
  ...
  Register_Send_Email_Msg:
    "Verification code has been sent to the designated mailbox! If you haven't received the email for a long time, please check whether your email is accurate!",
  ...
  ResetPwd_Send_Email_Msg:
    "Reset password email has been sent to the designated mailbox! If you haven't received the email for a long time, please check whether your email is accurate!",
  ...
  Change_Send_Email_Msg:
    "Verification code has been sent to the designated mailbox! If you haven't received the email for a long time, please check whether your email is accurate!",
  Change_Send_Mobile_Msg:
    "Verification code has been sent to the designated mobile! If you haven't received the message for a long time, please check whether your mobile is accurate!",
  Update_Successfully: "Update Successfully",
  Pass_Strength:
    "The password strength is too weak, and the password length is 6-20 digits and letters",
  ...
  is_incorrect_format_file:
    " is an incorrect format file,please choose the file format of .GIF, .JPG, .JPEG, .PNG, .BMP, .Webp",
  Exceed_max_size_limit: "Exceed max size limit",
  File_Exceed_Tips:
    " file size is wrong, you can upload a image up to 2MB in size",
  Cancel_Avater_Tips:
    "Are you sure you want to cancel the capture of this image?",
  ...
  List_Solved_Problems: "List of solved problems (All time)",
  List_Solved_Problems_Recent: "List of solved problems (Last 60 days)",
  UserHome_Not_Data: "The guy is so lazy that has not solved any problem yet.",
  Personal_Profile: "Persion Profile",
  UserHome_Solved_Problems: "Solved Problems (All time)",
  UserHome_Solved_Problems_Recent: "Solved Problems (Last 60 days)",
  Thermal_energy_table_submitted_in_the_last_year:
    "Thermal energy table submitted in the last year",
  ...
  Statistics_Submissions_In_The_Last_Week:
    "Statistics: Submissions In The Last Week",
  ...
  Touch_Get_Status:
    "Please touch or hover the mouse to the designated problem line to view the submission status",
  ...
  Login_to_view_your_submission_history:
  ...
  Put_away_the_full_screen_and_write_the_code:
    "Put away the full screen and write the code",
  ...
  Please_login_first_by_admin_account:
    "Please login again with the administrator account!",
  Submit: "Submit",
  ...
  Are_you_sure_you_want_to_reset_your_code:
    "Are you sure you want to reset the original code? If the problem has a code template, it will be restored to the code of the original template, otherwise the code being edited will be cleared.",
  Are_you_sure_you_want_to_get_your_recent_accepted_code:
    "Are you sure you want to get the recently passed code and fill it in the code box? Note: This operation will overwrite the code being edited!",
  You_havenot_passed_the_problem_so_you_cannot_get_the_code_passed_recently:
    "You haven't passed the problem, so you can't get the code passed recently",
  Code_can_not_be_empty: "Code can not be empty",
  Code_Length_can_not_exceed_65535:
    "The code should contain no more than 65535 characters!",
  Submit_code_successfully: "Submit code successfully",
  You_have_solved_the_problem: "You have solved the problem",
  Submitted_successfully: "Submitted successfully",
  Submitted_Not_Result:
    "Submitted successfully, but the result is not known at present",
  ...
  Cancel_Judge_Tips:
    "Are you sure you want to mark this submission as Cancelled?",
  ...
  Download_tips_1:
    "THE OJ provides the first non AC input / output data download of the record; Some questions do not open data download.",
  Download_tips_2: "Only 2 downloads per day, please pay attention to save",
  Download_tips_3:
    "Do not use this function to maliciously brush the AC number",
  ...
  Delete_Discussion_Tips:
    "This operation will delete the discussion, including the associated comments and replies. Do you want to continue?",
  ...
  The_report_label_and_reason_cannot_be_empty:
    "The report label and reason cannot be empty.",
  ...
  Protected_Tips:
    "Protected - Users need to register to participate in the competition.",
  Private_Tips:
    "Private - Only users knowing contest password required to enter the contest.",
  ...
  To_Enter_Confirm_Info:
    "To enter the Private contest, please iConfirm the Info!",
  ...
  Please_check_the_contest_announcement_for_details:
    "Please check the contest announcement for details",
  ...
  Contest_Rank_Search_Placeholder:
    "Please enter the user rank name or school name",
  ...
  Print_tips:
    "Please put the text to be printed into the content box, and then submit. Note: please do not submit maliciously!",
  Content: "Content",
  Content_cannot_be_empty: "Tne content cannot be empty!",
  The_number_of_content_cannot_be_less_than_50:
    "The number of words cannot be less than 50",
  Success_submit_tips:
    "Submitted successfully! Please wait patiently for the staff to print!",
  ...
  ID: "ID",
  Contest_Rejudge_Tips:
    "Are you sure you want to rejudge all submissions of the questions?",
  ...
  Formula_for_calculating_the_number_of_medals:
    "Formula for calculating the number of medals",
  Whether_to_remove_the_star_user: "Whether to remove the star user",
  Contest_Non_Ended_But_Want_to_Scroll_Board:
    "The contest is not over yet. Are you sure you want to sroll the board?",

  // /views/oj/contest/children/OIContestRank.vue
  Total_Score: "Total Score",
  Based_on_The_Highest_Score_Submitted_For_Each_Problem:
    "Based on the highest score submitted for each problem",
  Based_on_The_Recent_Score_Submitted_Of_Each_Problem:
    "Based on the recent score submitted of each problem",
  ...
  Pending_Description:
    "Your solution is waiting be judged, please wait for the result...",
  Submitted_Faild_Description:
    "Your submission failed this time, please click the button to submit again.",
  Compiling_Description:
    "Your source code is being compiled, please wait for the result...",
  Judging_Description:
    "Your program is running with test data. Please wait for the result...",
  ...
  Persentation_Error_Description:
    "The code you submitted is very close to the correct answer. Please check whether there are extra spaces, newlines and other blanks in the code format output.",
  Partial_Accepted_Description:
    "Come on! The code you submitted has passed some test points. Please consider other possibilities.",
  ...
  Time_Limit_Exceeded_Description:
    "The time your program used has exceeded limit.",
  ...
  Compile_Tips1:
    "`__int64` is not defined by ANSI standard and can only be used in `VC`. It should be written as `long long` type in `GNU C++`. For `scanf` and `printf`, please use `%lld` as the format.",
  Compile_Tips2:
    "The return value of `main()` must be defined as `int`, not `void`",
  Compile_Tips3: '`i` lost definition outside the loop,"for(int i=0...){...}"',
  Compile_Tips4:
    "`itoa` is not an ANSI standard function (not available in standard `C/C++`)",

  // /views/oj/about/Developer.vue
  Leader_BackEnd_FrontEnd_Engineer: "Leader & BackEnd | FrontEnd Engineer",
  Group_Function_Development_Contributor:
    "Group Function Development Contributor",
  Distributed: "Distributed",
  Distributed_Desc:
    "It is divided into frontend and backend separation, and supports the micro service cluster",
  Customization: "Customization",
  Customization_Desc:
    "The website configuration is highly integrated and supports customized modification",
  Security: "Security",
  Security_Desc:
    "The Sandbox is isolated by CGroup, and the website authority control is perfect",
  Diversity: "Diversity",
  Diversity_Desc:
    "Support Codefoces, HDU, POJ, GYM, AtCoder, SPOJ remote judge",
  Available: "Available",
  Faulty: "Faulty",
  ...
  Non_Test_Judge_Tips:
    "After entering the test case, click Running test, and the running results will be displayed here.",
  Problem_Uncertain_Answer:
    "Note: there may be multiple outputs that meet the requirements of this problem. Please judge whether the program output passes.",
  Fill_Case: "Fill Case",
  ...
  Announcement_of_contest_Q_and_A_area_tips1:
    "Please don't ask questions irrelevant to the contest. No irrigation!",
  Announcement_of_contest_Q_and_A_area_tips2:
    "During the contest, only the comments of yourself and the contest administrator can be seen!",
  Announcement_of_contest_Q_and_A_area_tips3:
    "The contest administrator's comments cannot be replied. The comments return to normal at the end of the contest!",
  ...
  Load_More: "Load More",
  Delete_Comment_Tips:
    "This operation will delete the comment and all its replies. Do you want to continue?",
  Delete_Reply_Tips:
    "This operation will delete the reply. Do you want to continue?",
  ...
  To_Enter_Training_Need_Password:
    "To enter the Private training, please input the password!",
  ...
  Total_AC: "Total  AC",
  Training_Rank_Search_Placeholder:
    "Please enter the user name, real name or school.",
  ...
  Group_Description_Check_Min_Max:
    "The length of group description is 5 to 1000",
  ...
  Exit_Group_Tips:
    "Are you sure you want to exit the group? After exiting, you will no longer be able to view group resources!",
  ...
  Delete_Member_Tips:
    "Are you sure you want to kick the member out of the group? After kicking out, the member will no longer be able to view group resources! What's more, if the member is the owner, the group will be disbanded together!",
  ...
  Group_Problem_Apply_Public_Tips:
    "Are you sure you want to apply for this problem to be added to the public bank?",
  Cancel_Group_Problem_Apply_Public_Tips:
    "Do you want to cancel the application for this problem to be added to the public bank?",
