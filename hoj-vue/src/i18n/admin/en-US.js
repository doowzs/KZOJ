export const m = {
  ...
  Please_check_your_username_or_password:
  ...
  Need_Bound_Problem:
    "You need to bind the topic before you can set the problem quintessence",
  ...
  OnlyAdmin: "OnlyAdmin",
  onlyStatus: "Black House",
  showLoginTime: "Show Login Time",
  User_Type: "User Type",
  Normal: "Normal",
  ...
  Import_User_Tips1:
    "The imported user data only supports user data in CSV format.",
  Import_User_Tips2:
    "There are eight columns of data: username, password, email, realname and gender. The username and password cannot be empty, others can be enmpty, otherwise the data in this row may fail to be imported.",
  Import_User_Tips3:
    'The first line does not need to write the eight column names ("username", "password", "email","realname","gender","nickname","school","class").',
  Import_User_Tips4:
    'If the gender is male, please use "male" or "0", if the gender is female, please use "female" or "1". If it is not filled in, it is assumed to be "secrecy".',
  Import_User_Tips5:
    "Please import the file saved as UTF-8 code, otherwise Chinese may be garbled.",
  ...
  Extra_Account_Tips:
    "Please enter the username of the account allowed to enter to the contest, separated by spaces.",
  ...
  The_end_number_cannot_be_less_than_the_start_number:
    "The end number cannot be less than the start number",
  Please_select_6_to_25_characters_for_password_length:
    "Please select 6 ~ 25 characters for password length",
  ...
  Delete_User_Tips:
    "Are you sure you want to delete this user? May be associated to delete the user created announcements, topics, competitions, etc.",
  The_number_of_users_selected_cannot_be_empty:
    "The number of users selected cannot be empty",
  The_number_of_problems_selected_cannot_be_empty:
    "The number of problems selected cannot be empty",
  Error_Please_check_your_choice: "Wrong, please check your choice.",
  Generate_User_Success:
    "All users in the specified format have been created successfully, and the user table has been downloaded to your computer successfully!",
  Generate_Skipped_Reason:
    "rows user data are filtered because it may be an empty row or a column(username or password) value is empty.",
  ...
  Delete_Announcement_Tips:
    "Are you sure you want to delete this announcement?",

  // /views/admin/general/SysNotice.vue
  SysNotice: "Notification",
  Notice_Admin: "Notification",
  Push_System_Notification_Every_Hour:
    "Tips: Push System Notification Every Hour",
  ...
  Hide_Non_Contest_Submission_Code:
    "Hide Non Master Station Contest Submission Code",
  Number_of_AC_required_for_ordinary_users_to_post:
    "Users can create discussion (Required AC)",
  Number_of_posts_that_users_can_create_per_day:
    "Number of Users can create discussion per day",
  Number_of_AC_required_for_Comment_of_ordinary_users:
    "Users can comment (Required AC)",
  Group_Config: "Group Config",
  Number_of_Groups_that_users_can_create_per_day:
    "Number of Users can create group per day",
  Total_number_of_groups_that_ordinary_users_can_create:
    "Total number of Users can create group",
  Number_of_AC_required_for_ordinary_users_to_create_group:
    "Users can create group (Required AC)",
  ...
  ACM_Contest_Add_From_Public_Problem_Tips:
    "ACM Contest: Only ACM type problem and Remote Judge problem can be imported",
  OI_Contest_Add_From_Public_Problem_Tips:
    "OI Contest: Only OI type problem and Remote Judge problem can be imported",
  ...
  Remove: "Remove",
  Delete_Problem_Tips:
    "Are you sure you want to delete this problem? Note: the relevant submission data for this issue will also be deleted.",
  Remove_Contest_Problem_Tips:
    "Are you sure you want to remove the problem from the contest?",
  Add_Successfully: "Add Successfully",
  Download_Testcase_Success:
    "The testcase of this problem has been downloaded successfully!",
  Enter_The_Problem_Display_ID_in_the_Contest:
    "Enter The Problem Display ID in the Contest",
  Problem_ID_is_required: "Problem ID is required",
  The_Problem_Display_ID_in_the_Contest_is_required:
    "The Problem Display ID in the Contest is required",
  Balloon_Color: "Balloon Color",
  Update_Balloon_Color_Successfully:
    "Update the Balloon color of the problem successfully!",
  ...
  Problem_Examples_Desc:
    "Problem Examples: please do not have more than 2 problem examples. Problem examples are not included in the testcase.",
  ...
  General_Judge_Mode_Tips:
    "General Judge: the contestant program reads the problem standard input file, executes the code logic to obtain the contestant's output, and compares the contents of the problem standard output file to obtain the problem judgment result",
  Special_Judge_Mode_Tips:
    "Special Judge: the output results required by the problem may not be unique, and different results are allowed. Therefore, a special program is needed to read standard output, player output and standard input, and compare them to obtain the final judgment result",
  Interactive_Judge_Mode_Tips:
  ...
  Code_template_of_the_language_cannot_be_empty:
    "Code template of the language cannot be empty!",
  Type: "Type",
  Read_Write_Mode: "Read-Write Mode",
  Standard_IO: "Standard IO",
  File_IO: "File IO",
  Exist_Explain: "Exist Explain",
  Input_File_Name: "Input File Name",
  Output_File_Name: "Output File Name",
  When_the_read_write_mode_is_File_IO_the_input_file_name_or_output_file_name_cannot_be_empty:
    "When the read-write mode is File IO, the input file name or output file name cannot be empty",
  ...
  Hint: "Hint",
  Source: "Source",
  Auto_Remove_the_Blank_at_the_End_of_Code:
    "Automatically Remove Whitespace at The End of Each Line of Code",
  Publish_the_Judging_Result_of_Test_Data:
    "Publish the Judging Result of Test Data",
  Edit_Problem: "Edit Problem",
  Edit_Problem_Auth: "Change Authority",
  Edit_Problem_Type: "Change Type",
  Edit_Problems: "Modify the title permission or type",
  Change_Judge_Mode:
    "Note: switching the judgment mode may change the evaluation logic!",
  ...
  Score_must_be_greater_than_or_equal_to_0:
  ...
  Spj_Or_Interactive_Code_not_Compile_Success:
    "Spj Or Interactive Code was not compiled successfully, please compile again!",
  Judge_Extra_File: "Judge Extra File",
  Judge_Extra_File_Tips1:
    "1. User Program: Provide additional library files for user program",
  Judge_Extra_File_Tips2:
    "2. Special Or Interactive Program: Provide additional library files for special or interactive programs",
  User_Program: "User Program",
  SPJ_Or_Interactive_Program: "Special Or Interactive Program",
  Non_Default_Judge_Case_Mode_And_Group_Num_IS_NULL:
    "The number of subtask groups of evaluation data cannot be empty!",
  ...
  Tag_Tips:
    "Note: By default, there is no tag classification column, and all tags are [Unclassified]. Please click [Add Tag Classification] in the upper left corner to add tag classification, and then click tag modification #Tag Classification# to classify.",
  ...
  Delete_Tag_Classification_Tips:
    "Are you sure you want to delete this tag classification? Prompt: This operation will attribute the labels under this classification to unclassified!",
  ...
  Delete_Training_Tips:
    "This operation will delete the training and its submission, rank record and other data. Do you want to continue?",
  ...
  Redirect_To_Category:
    "The category list of current training is empty. Please go to create category first!",
  Redirect: "Redirect",
  ...
  Remove_Training_Problem_Tips:
    "Are you sure you want to remove the problem from the training?",
  ...
  Delete_Contest_Tips:
    "This operation will delete the contest and its submission, discussion, announcement, record and other data. Do you want to continue?",
  ...
  Contest_Duration_Check:
    "The duration of the contest cannot be less than or equal to zero!",
  ...
  Allow_Submission_After_The_Contest_Ends:
    "Allow Submission after the contest ends",
  Public: "Public",
  Private: "Private",
  Protected: "Protected",
  ...
  Top: "Top",
  isTop: "Top or not",
  isExplain: "Explain Choicest",
  onlyExplain: "Only Explain",
  Discussion_Report: "Discussion Report",
  Reporter: "Reporter",
  Report_Time: "Report Time",
  View_Report_content: "View Report Content",
  View_Discussion: "View Discussion Detail",
  Bound_Problem: "Bound Problem",
  Add_Bound_Problem: "Add Bound Problem",
  Content: "Content",
  Report_Content: "Report Content",
  The_number_of_discussions_selected_cannot_be_empty:
    "The number of discussions selected cannot be empty",
  Views: "Views",
  LikeMsg: "Likes",
  Checked: "Checked",
  ...
  Applying: "Applying",
  Refused: "Refused",
  Only_Group_Discussion: "Only Group Discussion",
};
