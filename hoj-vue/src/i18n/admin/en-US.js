export const m = {
  ...
  Need_Bound_Problem: 'You need to bind the topic before you can set the problem quintessence',
  ...
  Import_User_Tips2: 'There are eight columns of data: username, password, email, realname and gender. The username and password cannot be empty, others can be enmpty, otherwise the data in this row may fail to be imported.',
  Import_User_Tips3:'The first line does not need to write the eight column names ("username", "password", "email","realname","gender","nickname","school","class").',
  ...
  The_number_of_problems_selected_cannot_be_empty:'The number of problems selected cannot be empty',
