  ...
  <div>
    <el-card>
      ...
      >
        ...
        >
          <template v-slot="{ row }">
            <span v-if="row.judgeMode == 'default'">{{
              $t("m.General_Judge")
            }}</span>
            <span v-else-if="row.judgeMode == 'spj'">{{
              $t("m.Special_Judge")
            }}</span>
            <span v-else-if="row.judgeMode == 'interactive'">{{
        ...
        <vxe-table-column min-width="120" :title="$t('m.Examine')">
          <template v-slot="{ row }">
            ...
            >
              ...
              <el-option :label="$t('m.Agreed')" :value="2"></el-option>
              <el-option :label="$t('m.Refused')" :value="3"></el-option>
            </el-select>
          </template>
        </vxe-table-column>
      </vxe-table>
