      ...
      <el-row :gutter="20">
        <el-col :xs="24" :md="12">
          <el-card>
            ...
            >
              ...
              <el-form-item
                :label="$t('m.Hide_Non_Contest_Submission_Code')"
                label-width="320px"
              >
                <el-switch
              ...
              <el-form-item
                :label="$t('m.Non_Contest_Submission_Frequency')"
                label-width="320px"
              >
                <el-input-number
        ...
        <el-col :xs="24" :md="12">
          <el-card class="card-top">
            ...
            >
              <el-form-item
                :label="$t('m.Open_Public_Discussion')"
                label-width="320px"
              >
                <el-switch
              ...
              <el-form-item
                :label="$t('m.Open_Group_Discussion')"
                label-width="320px"
              >
                <el-switch
              ...
              <el-form-item
                :label="$t('m.Open_Contest_Comment')"
                label-width="320px"
              >
                <el-switch
              ...
              <el-form-item
                :label="
                  $t('m.Number_of_AC_required_for_ordinary_users_to_post')
                "
                label-width="320px"
              >
                <el-input-number
              ...
              <el-form-item
                :label="$t('m.Number_of_posts_that_users_can_create_per_day')"
                label-width="320px"
              >
                <el-input-number
              ...
              <el-form-item
                :label="
                  $t('m.Number_of_AC_required_for_Comment_of_ordinary_users')
                "
                label-width="320px"
              >
                <el-input-number
        ...
        <el-col :xs="24" :md="12">
          <el-card class="card-top">
            ...
            >
              <el-form-item
                :label="$t('m.Number_of_Groups_that_users_can_create_per_day')"
                label-width="320px"
              >
                <el-input-number
              ...
              <el-form-item
                :label="
                  $t('m.Total_number_of_groups_that_ordinary_users_can_create')
                "
                label-width="320px"
              >
                <el-input-number
              ...
              <el-form-item
                :label="
                  $t(
                    'm.Number_of_AC_required_for_ordinary_users_to_create_group',
                  )
                "
                label-width="320px"
              >
