  ...
  <el-row :gutter="18">
          ...
          <section>
            ...
            <div>
              ...
              <el-tag
                ...
                v-if="
                  ((true || isAdminRole || isSuperAdmin || isProblemAdmin) &&
                    problemBank.key == 'Group') ||
                  ((isSuperAdmin || isProblemAdmin) &&
                    problemBank.key == 'Contest') ||
    ...
    <el-col :sm="24" :md="6" :lg="6">
      ...
      <el-card :padding="10" style="margin-top: 20px">
        ...
        <template
          v-if="searchTagClassificationList.length > 0"
          v-loading="loadings.tag"
        >
          <el-row
            :gutter="10"
