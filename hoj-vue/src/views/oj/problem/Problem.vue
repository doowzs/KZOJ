                ...
                <div id="problem-content">
                  ...
                  <template v-if="problemData.problem.input">
                    <p class="title">
                      ...
                      <span v-if="problemData.problem.isFileIO">({{
                          $t('m.Input_File')
                        }}:{{ problemData.problem.ioReadFileName }})</span>
                    </p>
                  ...
                  <template v-if="problemData.problem.output">
                    <p class="title">
                      ...
                      <span v-if="problemData.problem.isFileIO">({{
                          $t('m.Output_File')
                        }}:{{ problemData.problem.ioWriteFileName }})</span>
                    </p>
                    <Markdown
                        class="md-content"
                        :isAvoidXss="problemData.problem.gid != null"
                  ...
                  >
                    ...
                    <span
                      ...
                      <span>
                        ...
                        <span><span class="hidden-xs-only"> {{ $t('m.Comment') }}:</span>
                        ...
                        <span><span class="hidden-xs-only"> {{ $t('m.Likes') }}:</span>
                          {{ discussion.likeNum }}
                        </span>
                      </span>
                        ...
                        <span><span class="hidden-xs-only"> {{ $t('m.Views') }}:</span>
                          {{ discussion.viewNum }}
                        </span>
                      </span>
